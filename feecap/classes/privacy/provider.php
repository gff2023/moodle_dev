 ...
 *
 * @package    enrol_feecao
 * @category   privacy
 * @copyright  2020 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace enrol_feecap\privacy;
...
/**
 * Privacy Subsystem for enrol_feecap implementing null_provider.
 *
 * @copyright  2020 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
    ...
    \core_payment\privacy\consumer_provider
{
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        $subcontext = [
            get_string('pluginname', 'enrol_feecap'),
        ];
        foreach ($contextlist as $context) {
            if (!$context instanceof \context_course) {
                continue;
            }
            $feeplugins = $DB->get_records('enrol', ['courseid' => $context->instanceid, 'enrol' => 'feecap']);
